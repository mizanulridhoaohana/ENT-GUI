...
ASSETS_PATH = OUTPUT_PATH / Path(r"G:\ENT Project\export\build\assets\frame6")
...
button_5.place(
    x=1231.9999923706055,
    y=589.000001591123,
    width=96.00001309729032,
    height=44.99999840887702
)
...
canvas.create_text(
    ...
    140.0,
    anchor="nw",
    text="Mohon atur tingkat tekanan sesuai keadaan untuk memperoleh hasil yang optimal. Harap gunakan dengan hati-hati.",
    fill="#14181F",
    font=("Nunito Regular", 14 * -1)
)
