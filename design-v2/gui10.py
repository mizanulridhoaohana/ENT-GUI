...
ASSETS_PATH = OUTPUT_PATH / Path(r"G:\ENT Project\export\v2\build\assets\frame10")
...
canvas.create_text(
    ...
    478.0,
    anchor="nw",
    text="Silakan atur tingkat tekanan sesuai keadaan pasien untuk memperoleh hasil yang optimal. Harap gunakan dengan hati-hati.",
    fill="#14181F",
...
canvas.create_text(
    ...
    866.0,
    anchor="nw",
    text="Note: Mohon pastikan gambar terlihat jelas, dan berada dalam posisi ideal untuk diambil.",
    fill="#14181F",
